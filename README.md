...
Both packages include their SIL Open Font License. The portrait uses the user-supplied 2508px transparent PNG without cropping or a circular background. It sits above the greeting, aligned with the text. The source resume
